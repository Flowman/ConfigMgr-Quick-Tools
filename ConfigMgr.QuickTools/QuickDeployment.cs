...
namespace ConfigMgr.QuickTools
{
    class QuickDeployment
    {
        ...
        public bool HasError { get { return Error == null ? false : true; } }
        ...
        private QuickDeployment()
        {
            ...
            DateTime patchTuesday = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 01).Next(DayOfWeek.Tuesday).AddDays((2 - 1) * 7);
